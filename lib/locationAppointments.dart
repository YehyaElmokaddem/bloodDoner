...
class LocationAppointment extends StatefulWidget {
  ...
  LocationAppointment({@required this.uid});
  @override
  _LocationAppointmentState createState() => _LocationAppointmentState();
}
                                ...
                                FlatButton.icon(icon: Icon(Icons.list),
                                  onPressed: (){
                                    Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                            builder: (_) =>
                                                AdminAppointmentsScreen(uid: widget.uid, location: Locations.get("locationName"))));
                                  },
